...
Public Class SettingsViewModel
    ...
    Public Property CtrlF12 As String
        Get
            Try
                logger.Debug("Lecture de la propriété CtrlF12")
                Return _userSettings.CtrlF12
            Catch ex As Exception
        ...
        Set(ByVal value As String)
            Try
                ' Mise à jour des paramètres uniquement si la valeur change
                If _userSettings.CtrlF12 <> value Then
                    _userSettings.CtrlF12 = value
                    _userSettings.Save()
                    NotifyPropertyChanged("CtrlF12")
                    logger.Info($"La valeur de CtrlF12 a été modifiée : {value}")
                End If
            Catch ex As Exception
    ...
    Public Property ShiftF12 As String
        Get
            Try
                logger.Debug("Lecture de la propriété ShiftF12")
                Return _userSettings.ShiftF12
            Catch ex As Exception
        ...
        Set(ByVal value As String)
            Try
                ' Mise à jour des paramètres uniquement si la valeur change
                If _userSettings.ShiftF12 <> value Then
                    _userSettings.ShiftF12 = value
                    _userSettings.Save()
                    NotifyPropertyChanged("ShiftF12")
                    logger.Info($"La valeur de ShiftF12 a été modifiée : {value}")
                End If
            Catch ex As Exception
    ...
    Public Property ShiftF12Enabled As Boolean
        Get
            Try
                logger.Debug("Lecture de la propriété ShiftF12Enabled")
                Return _userSettings.ShiftF12Enabled
            Catch ex As Exception
        ...
        Set(ByVal value As Boolean)
            Try
                ' Mise à jour des paramètres uniquement si la valeur change
                If _userSettings.ShiftF12Enabled <> value Then
                    _userSettings.ShiftF12Enabled = value
                    _userSettings.Save()
                    NotifyPropertyChanged("ShiftF12Enabled")
                    logger.Info($"La valeur de ShiftF12Enabled a été modifiée : {value}")
                End If
            Catch ex As Exception
